 ...
 * Plugin Name: WP Bootstrap4.4.1 Navwalker
 * Plugin URI:  https://github.com/lxc047/wp_bootstrap_navwalker
 * Description: A custom WordPress nav walker class to implement the Bootstrap 4.4.1 navigation style in a custom theme using the WordPress built in menu manager.
 * Author: Laxman Chhetri
 * Version: 1.0.0
 * Author URI: https://github.com/lxc047/
 * GitHub Plugin URI: https://github.com/lxc047/wp_bootstrap_navwalker
...
if ( !class_exists( 'WP_Bootstrap_Navwalker' ) ) {
   ...
   *
   * @since          1.0.0
   * @see            https://getbootstrap.com/docs/4.4.1/components/navbar/
  ...
  class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
      ...
      if ( $args->walker->has_children ) {
        ...
        $item_output .= '</a><span class="dropdown-icon fa fa-plus"></span>';
